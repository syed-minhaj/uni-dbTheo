...
import { ReturnError, returnBook, getActiveTransactionByQrCode } from "@/lib/services/issue-service";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ message: "Book returned successfully.", ...result });
  } catch (error) {
